...
export const aboutTimelineData: HorizontalTimelineItem[] = [
  {
    ...
    imageFile: 'assets/images/about/offices/tokyo-hq.webp',
    detail: (
  ...
  },
  {
    ...
    imageFile: 'assets/images/services/office-solution.webp',
    detail: (
      <div className="space-y-2">
  ...
  },
  {
    ...
    imageFile: 'assets/images/about/offices/sendai-branch.webp',
    detail: (
      <div className="space-y-2">
        <p>2012/02　仙台支店を開設</p>
  ...
  },
  {
    ...
    imageFile: 'assets/images/services/it-solution.webp',
    detail: (
      <div className="space-y-2">
  ...
  },
  {
    ...
    imageFile: 'assets/images/services/air-conditioner.webp',
    detail: (
      <div className="space-y-2">
  ...
  },
  {
    ...
    imageFile: 'assets/images/about/carousel/about-image-carousel-11.webp',
    detail: (
      <div className="space-y-2">
  ...
  },
  {
    ...
    imageFile: 'assets/images/services/primesign.webp',
    detail: (
      <div className="space-y-2">
...
export const aboutPhilosophyCards = [
  {
    ...
    bgImageFile: 'assets/images/about/philosophy/about-philosophy-innovation-1.webp',
    hoverImageFile: 'assets/images/about/philosophy/about-philosophy-innovation-2.webp',
  },
  {
    title: "Passion",
    desc: "お客様への情熱と品質へのこだわりを、細部まで徹底し貫き通す。",
    bgImageFile: 'assets/images/about/philosophy/about-philosophy-passion-1.webp',
    hoverImageFile: 'assets/images/about/philosophy/about-philosophy-passion-2.webp',
  },
  {
    title: "Speed",
    desc: "変化の激しい時代に、迅速な意思決定で、素早く実行へつなげる。",
    bgImageFile: 'assets/images/about/philosophy/about-philosophy-speed-1.webp',
    hoverImageFile: 'assets/images/about/philosophy/about-philosophy-speed-2.webp',
  },
  {
    title: "Teamwork",
    desc: "個々の力を最大化し、チームとして連携し、最高の成果を生み出す。",
    bgImageFile: 'assets/images/about/philosophy/about-philosophy-team-1.webp',
    hoverImageFile: 'assets/images/about/philosophy/about-philosophy-team-2.webp',
  },
];
...
export const aboutOffices: AboutOffice[] = [
  ...
  },
  {
    ...
    phone: '092-263-5888',
    imageFile: 'assets/images/about/offices/fukuoka-branch.webp',
